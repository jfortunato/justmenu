(function(window){
    ...
    View.prototype.bind = function(event, handler) {
        ...
        } else if (event === 'slideOut') {
            this.$slideBtn.addEventListener('click', function (e) {
                handler();
            }.bind(this));
        }
    };
    ...
    View.prototype.toggleSlide = function() {
        var menu = document.querySelector('[data-justmenu]');
