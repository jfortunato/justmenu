...
<html ng-app="justmenu">
    ...
    <body>
        ...
        <script src="assets/angular/components/admin/admin.js"></script>
        <script src="assets/angular/components/admin/admin-controller.js"></script>
        <script src="assets/angular/components/admin/admin-directive.js"></script>
    </body>
</html>
